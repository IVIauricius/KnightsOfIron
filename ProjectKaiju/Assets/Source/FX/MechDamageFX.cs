...
public class MechDamageFX : MonoBehaviour {
    public List<GameObject> myDamageEffects;    // My effects prefabs.
    public PlayerHealth myHealth;               // Reference to the PlayerHealth script.
    ...
    // This script runs every frame. Assumes that the player has four effects attached.
    void Run()
    {
        // 80% Check.
