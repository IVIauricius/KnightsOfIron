...
public class EnemyProjectile : ProjectileMauro
{
    ...
    {
        // Detect if the object I'm colliding with has health.
        ...
        if (other.gameObject.GetComponentInParent<PlayerHealth>())
        {
            ...
            other.gameObject.GetComponentInParent<PlayerHealth>().TakeDamage(damagePower);
        }
